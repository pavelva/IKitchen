...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:GridView ID="MyPurchasesTable" CssClass="MyPurchasesTable" runat="server" AllowPaging="true" AutoGenerateColumns="False" DataKeyNames="" DataSourceID="MyPurchasesDataSource">
        ...
        <Columns>
            ...
            <%--<asp:BoundField DataField="product_desc" HeaderText="תיאור"  ReadOnly="True" SortExpression="productDesc" />--%>
    ...
    <asp:SqlDataSource ID="MyPurchasesDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:IKitchenDB %>" SelectCommand="SELECT * FROM users">
        <SelectParameters>
            <%--<asp:QueryStringParameter Name="Param1" QueryStringField="isbn" />--%>
        </SelectParameters>
    </asp:SqlDataSource>
